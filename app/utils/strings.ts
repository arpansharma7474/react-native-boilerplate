export default {
  ...
  error_block:
    'Your account has blocked.For more info, Please contact store-admin',
  ...
  error_invalid_license_plate_number:
    'Please enter a valid license plate number',
  error_invalid_color_special_char:
    'Color name cannot have  special characters',
  error_license_plate_length:
    'The License Plate Number cannot be less than 10 digits',
  ...
  error_license_plate_startspace:
    'License Plate Number cannot start with a space',
